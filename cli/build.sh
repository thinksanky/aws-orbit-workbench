...
echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++"
orbit init -n "sky-orbit-env" -r us-east-1
cp -R /tmp/default-env-manifest.yaml conf/
...
echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++"
orbit deploy toolkit -f conf/default-env-manifest.yaml
...
echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++"
orbit deploy images -f conf/default-env-manifest.yaml
...
echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++"
orbit deploy env -f conf/default-env-manifest.yaml